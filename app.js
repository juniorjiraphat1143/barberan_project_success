...
app.get('/donate',middleware.isLoggedIn,function(req,res){
  res.render('donate');
})
app.get('/contact',middleware.isLoggedIn,function(req,res){
  res.render('contact');
})
app.get('/hospital',middleware.isLoggedIn,function(req,res){
  res.render('hospital');
})
app.get('/covid19',middleware.isLoggedIn,function(req,res){
  res.render('covid19');
})
